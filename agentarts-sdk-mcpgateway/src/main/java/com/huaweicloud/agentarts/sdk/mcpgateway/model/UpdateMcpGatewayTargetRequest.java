...
/**
 * Request body for updating an MCP gateway target.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class UpdateMcpGatewayTargetRequest {
    ...
    public UpdateMcpGatewayTargetRequest() {
    }
    ...
    public UpdateMcpGatewayTargetRequest withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateMcpGatewayTargetRequest withDescription(String description) {
        this.description = description;
        return this;
    }
    ...
    public UpdateMcpGatewayTargetRequest withTargetConfiguration(Map<String, Object> targetConfiguration) {
        this.targetConfiguration = targetConfiguration;
        return this;
    }
    ...
    public UpdateMcpGatewayTargetRequest withCredentialProviderConfiguration(Map<String, Object> credentialProviderConfiguration) {
        this.credentialProviderConfiguration = credentialProviderConfiguration;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        UpdateMcpGatewayTargetRequest that = (UpdateMcpGatewayTargetRequest) o;
